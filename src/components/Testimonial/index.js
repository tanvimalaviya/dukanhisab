...
//         {/* Heading */}
//         <h2 className="!text-6xl font-bold mb-4 ">Testimonials</h2>
...
//           <button
//             onClick={prevSlide}
//             className="bg-white text-indigo-900 p-3 rounded-full shadow-lg hover:bg-indigo-100 transition"
//           >
//             <FaArrowLeft />
//           </button>
//           <button
